      ...
      <div className="container-custom py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400 mt-4">
              Chăm sóc thú cưng chuyên nghiệp với đội ngũ giàu kinh nghiệm và yêu thương động vật.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/service" className="text-sm hover:text-primary-400 transition-colors">
                  Dịch vụ Spa
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/account" className="text-sm hover:text-primary-400 transition-colors">
                  Tài khoản của tôi
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/account?tab=orders" className="text-sm hover:text-primary-400 transition-colors">
                  Theo dõi đơn hàng
                </Link>
              </li>
              <li>
                <Link to="/account?tab=appointments" className="text-sm hover:text-primary-400 transition-colors">
                  Lịch hẹn của tôi
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-2">
                ...
                <span className="text-sm">Hotline: 19001234</span>
              </li>
              <li className="flex items-center gap-2">
                <svg className="w-5 h-5 text-primary-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className="text-sm">Email: petshop140@gmail.com</span>
              </li>
              <li className="flex items-center gap-2">
                <svg className="w-5 h-5 text-primary-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center">
          <p className="text-sm text-gray-400">
            &copy; {currentYear} PetSpa140. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
